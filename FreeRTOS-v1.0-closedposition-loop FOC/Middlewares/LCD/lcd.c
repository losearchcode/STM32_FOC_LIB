...
void LCD_Show_Dynamic(void* parameter)
{
	...
	if(param -> AS5600_angle_Show == NULL)
	{
		LCD_ShowString(0,60,"Failure",RED,WHITE,24,0);
		LCD_ShowFloatNum1(120,60,404.40,5,RED,WHITE,24);
	}
	...
	uint8_t LED_Hz_level =(uint8_t)	param -> LED1_Delay_time_Show;
	LCD_ShowIntNum(120,120,(uint8_t)(LED_Hz_level),4,RED,WHITE,24);
	
	uint32_t xElapsedTime_Show =	param -> xElapsedTime_Show;
	LCD_ShowIntNum(120,144,(uint32_t)(xElapsedTime_Show),4,RED,WHITE,24);
