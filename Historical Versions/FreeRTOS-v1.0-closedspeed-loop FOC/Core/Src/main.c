...
{	
  ...
  while (1)
  {
		...
		else
		{
			...
			//设置速度
			DFOC_M0_setVelocity(&FOC_Init_Parameter[0],LED1_Delay_time*6);
//			DFOC_M0_set_Velocity_Angle(&FOC_Init_Parameter[0],LED1_Delay_time*1.28);
//			DFOC_M0_set_Force_Angle(&FOC_Init_Parameter[0],LED1_Delay_time*1.256);
...
//			LCD_Show_Parameter.AS5600_angle_Show = getSensorAngle(&Sensor_AS5600_Parameter[0]);
