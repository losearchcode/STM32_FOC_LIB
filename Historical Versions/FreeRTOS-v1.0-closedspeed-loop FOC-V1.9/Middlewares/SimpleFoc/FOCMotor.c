...
float shaftVelocity(uint8_t Motor_No)
{
  ...
  return FOC_Para_M[Motor_No].Motor_Properties_.Sensor_DIR*LPFoperator(&FOC_Para_M[Motor_No].LPF_velocity,getVelocity(Motor_No));
//	return FOC_Para_M[Motor_No].Motor_Properties_.Sensor_DIR*LPF_velocity_(getVelocity(Motor_No));
