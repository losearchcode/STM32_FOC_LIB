...
extern __IO uint32_t TIM7_Tick;
...
#define TIM_TimeBaseStructure htim6
...
void TIM7_IncTick(void);
uint32_t TIM7_GetTick(void);


/* USER CODE BEGIN Prototypes */
void Set_TIM_PWM_CCRx(TIM_HandleTypeDef* TimHandle,uint32_t Channel,float PWM_dc);
