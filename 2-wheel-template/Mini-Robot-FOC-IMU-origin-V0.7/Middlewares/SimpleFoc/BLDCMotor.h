...
typedef struct {
	...
	Current_Param_t				Inline_Current_Param_;
	LowPassFilter_t				LPF_current_q;
	LowPassFilter_t				LPF_current_d;
	LowPassFilter_t				LPF_velocity;
	PIDController_t				PID_Vel_;
	PIDController_t				PID_Angle_;
	PIDController_t				PID_current_q_;
	PIDController_t				PID_current_d_;
} FOC_Para_All_t;
