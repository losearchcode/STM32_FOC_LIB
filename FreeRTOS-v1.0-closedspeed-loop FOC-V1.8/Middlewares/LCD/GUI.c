...
GUI_Parameter_t GUI1_SubMenu_Para[]=
																{	
																	...
																	{"Motor_PP:", &FOC_Para_M[0].Motor_Properties_.Motor_Pole_Pairs, NULL,INT},
																	{"Sen_DIR: ", &FOC_Para_M[0].Motor_Properties_.Sensor_DIR, NULL,INT},
...
GUI_Parameter_t GUI2_SubMenu_Para[]=
																{	
																	{"P:       ", &(FOC_Para_M[0].PID_Vel_.P), 1,FLOAT},
																	{"I:       ", &(FOC_Para_M[0].PID_Vel_.I), 1,FLOAT},
																	{"Vel_Tf:     ", &FOC_Para_M[0].LPF_velocity.Tf, 1,FLOAT},
																	{"D:       ", &(FOC_Para_M[0].PID_Vel_.D), 1,FLOAT},
//																	{"E:       ", &(FOC_Para_M[0].PID_Vel_.error_prev), NULL,FLOAT},
																	{"Vel:     ", &LCD_Show_Parameter.xCurrent_Vel_Show, NULL,FLOAT},
																	{"Target:  ", &target, 1,FLOAT},
																	
																	{"xElTime: ", &(FOC_Para_M[0].LPF_velocity.Lowpass_Timecount.xElapsedTime_t), NULL,INT},
																};
...
GUI_Parameter_t GUI3_SubMenu_Para[]=
																{	
																	{"P:       ", &(FOC_Para_M[0].PID_Angle_.P), 1,FLOAT},
																	{"I:       ", &(FOC_Para_M[0].PID_Angle_.I), 1,FLOAT},
																	{"D:       ", &(FOC_Para_M[0].PID_Angle_.D), 1,FLOAT},
																	{"E:       ", &(FOC_Para_M[0].PID_Angle_.error_prev), NULL,FLOAT},
																	{"Target:  ", &target, 1,FLOAT},
																	{"Angle:   ", &LCD_Show_Parameter.AS5600_angle_Show, NULL,FLOAT},
																};
...
GUI_MenuItem_t GUI_MainMenu[Main_Menu_Num] = {
    ...
    {"Speed_PID", NULL, GUI2_SubMenu_Para, 7},
					...
					else
					{
						...
						case 2:
							if(GUI_Index_Current.Main_Menu_Index != 0 && GUI_Index_Current.Submenu_Index < 4 )
								*(float *)GUI_MainMenu[GUI_Index_Current.Main_Menu_Index].Parameters[GUI_Index_Current.Submenu_Index].Value -= 0.00001f;
							else
								*(float *)GUI_MainMenu[GUI_Index_Current.Main_Menu_Index].Parameters[GUI_Index_Current.Submenu_Index].Value -= 1.0f;	
							break;
						case 3:
							if(GUI_Index_Current.Main_Menu_Index == 0 && GUI_Index_Current.Submenu_Index < 4 )
								*(double *)GUI_MainMenu[GUI_Index_Current.Main_Menu_Index].Parameters[GUI_Index_Current.Submenu_Index].Value -= 0.00001f;
							else
								*(double *)GUI_MainMenu[GUI_Index_Current.Main_Menu_Index].Parameters[GUI_Index_Current.Submenu_Index].Value -= 1.0f;	
							break;
						default:
							// 处理未知类型或错误情况
